...
CREATE TABLE `article`  (
  ...
  `label` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '标签ID，多个ID以逗号分隔',
...
CREATE TABLE `user`  (
  ...
  `role` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'user' COMMENT '用户身份：admin/viewer/user',
